...
#define MAVLINK_MSG_ID_MPC_INPUTS_LEN 28
#define MAVLINK_MSG_ID_MPC_INPUTS_MIN_LEN 28
#define MAVLINK_MSG_ID_227_LEN 28
#define MAVLINK_MSG_ID_227_MIN_LEN 28

#define MAVLINK_MSG_ID_MPC_INPUTS_CRC 236
#define MAVLINK_MSG_ID_227_CRC 236
...
static inline uint16_t mavlink_msg_mpc_inputs_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint64_t time_usec, const float *mpc_ref_in, const float *mpc_mo_in, int32_t state)
{
...
{
    return mavlink_msg_mpc_inputs_pack(system_id, component_id, msg, mpc_inputs->time_usec, mpc_inputs->mpc_ref_in, mpc_inputs->mpc_mo_in, mpc_inputs->state);
}
...
{
    return mavlink_msg_mpc_inputs_pack_chan(system_id, component_id, chan, msg, mpc_inputs->time_usec, mpc_inputs->mpc_ref_in, mpc_inputs->mpc_mo_in, mpc_inputs->state);
}
...
static inline void mavlink_msg_mpc_inputs_send(mavlink_channel_t chan, uint64_t time_usec, const float *mpc_ref_in, const float *mpc_mo_in, int32_t state)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_MPC_INPUTS_LEN];
    _mav_put_uint64_t(buf, 0, time_usec);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_mpc_inputs_send(chan, mpc_inputs->time_usec, mpc_inputs->mpc_ref_in, mpc_inputs->mpc_mo_in, mpc_inputs->state);
#else
 ...
 */
static inline void mavlink_msg_mpc_inputs_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t time_usec, const float *mpc_ref_in, const float *mpc_mo_in, int32_t state)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
